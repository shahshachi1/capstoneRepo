...
prepare() {
  #Fetch Tensorflow
  cd ${basedir}
  wget https://github.com/tensorflow/tensorflow/archive/refs/tags/v${_pkgver}.tar.gz
  tar xvf v${_pkgver}.tar.gz
  #Fetch patches
  wget https://gitlab.archlinux.org/archlinux/packaging/packages/tensorflow/-/raw/main/fix-c++17-compat.patch
  wget https://gitlab.archlinux.org/archlinux/packaging/packages/tensorflow/-/raw/main/tensorflow-2.10-sparse-transpose-op2.patch
